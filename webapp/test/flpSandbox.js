		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapui5walkthroughsapui5walkthrough-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5walkthroughsapui5walkthrough-display": {
								"semanticObject": "sapui5walkthroughsapui5walkthrough",
								"action": "display",
								"description": "SAPUI5 Walkthrough",
								"title": "SAPUI5 Walkthrough",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui5.walkthrough.sapui5walkthrough",
									"url": sap.ui.require.toUrl("sap/ui5/walkthrough/sapui5walkthrough")
								}
							}
						}
					}
